...
public class FotoDAO implements DAO {
    ...
    public void excluir(Object ob) throws Exception {
        ...
        try {
            conn = this.conn;
            ps = conn.prepareStatement("DELETE FROM FOTO WHERE FOTO_ID_PRO=?");
            ps.setInt(1, foto.getFOTO_ID_PRO());
            ps.executeUpdate();
